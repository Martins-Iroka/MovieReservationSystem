...
object UserRefreshTokenTable : IntIdTable("refresh_tokens") {
...
class UserRefreshTokenEntity(id: EntityID<Int>) : IntEntity(id) {
    companion object : IntEntityClass<UserRefreshTokenEntity>(UserRefreshTokenTable)

    var userId by UserEntity referencedOn UserRefreshTokenTable.userId
